...
> **Epic**: Proje Kurulumu
> **Status**: Ready — **GATE KOŞULU #1 (BLOCKING)**: gate-check 2026-08-09 kabul koşulu; bu story kapanmadan hiçbir sistem story'si Done sayılmaz
> **Layer**: Foundation
> **Type**: Logic
> **Estimate**: S (~2h)
...
**Engine Notes**: Unity Test Framework built-in; game-ci/unity-test-runner@v4 `UNITY_LICENSE` secret'ı ister — **manuel önkoşul, kullanıcı ekler** (game.ci/docs/github/activation).
...
- [ ] CI koşusu yeşil: push'ta editmode+playmode adımları geçiyor (`UNITY_LICENSE` eklendikten sonra); gerekiyorsa workflow'a `projectPath: game` eklendi
